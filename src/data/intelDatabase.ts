...
무단 열람 시 추적 프로토콜이 자동 가동됩니다.`,
...

 {
  code: "tr1umph",
    ...
    text: `내부의 불안정을 외부와의 갈등으로 돌려 해결하는 수법은, 고전적이나 성과가 뚜렷하다. 그러나 이번 작전은 그뿐만이 아니다. 새로운 영토를 확보하고, '기반'을 확충한다. 잃어버린 그 영토들을 수복하기 위하여... 
...

 {
  code: "br0ken",
    ...
    무엇보다, 현재 항만이 마비되어 추후 진행해야할 계획들에 큰 차질이 발생할 것입니다. 신속히 대파국과 협력하여 항만을 복구해야만 할 것입니다.
